      ...
      <div className="max-w-[1680px] mx-auto px-6 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-black text-on-surface leading-[1.15] mb-6 tracking-tight">
            ...
            {/* Micro Specs Banner */}
            <div className="grid grid-cols-3 gap-6 pt-10 border-t border-gray-100 mt-10 w-full max-w-xl">
              <div>
